...
if( $pword == $c_pword)
{
    $sql = "INSERT INTO `login2` ( `username`, `password`, `date`) VALUES ( '$uname', '$pword', CURRENT_TIMESTAMP);";
...
<div class="navi">
    ...
    <div class="container">
        ...
        <?php
         ...
         if ( $sure == true ) {
         echo " <h5> Sign-in successfully </h5> ";   
         }
         if ( $dif_pass == true ) {
        ...
        <br>
        <br>
        <a href="admin_login.php">Cleck here to log-in...</a>
